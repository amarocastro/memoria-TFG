...
\begin{subsection}{Almacenamiento}
    ...
    % Basándose en los perfiles que VMware establece para su producto vSAN Ready Node\cite{host-requirements}, 
...
\begin{subsection}{Red}
 \begin{subsubsection}{Switch Top Of Rack}
    ...
    %  etiquetado \textit{Quality of Service} (QoS) de tráfico
