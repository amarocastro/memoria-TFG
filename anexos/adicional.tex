...
\lstinputlisting[language=yaml]{anexos/blueprint/windows-server-centOS8.yaml}
...
\lstinputlisting[language=yaml]{anexos/blueprint/wordpress-mysql-CentOS8-1VM.yaml}